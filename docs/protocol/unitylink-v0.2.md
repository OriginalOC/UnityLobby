...
- Registries: [registries-v0.2.md](registries-v0.2.md)
- App Metadata TLVs: [app-metadata-tlvs-v0.md](app-metadata-tlvs-v0.md)
- UnityGPU Stream: [unitygpu-stream-v0.md](unitygpu-stream-v0.md)
- Test vectors: [../../test-vectors/frames/](../../test-vectors/frames/)

## Status
- v0.2: frozen (wire format must remain stable)
- Corrections: go to [v0.2-errata.md](v0.2-errata.md)
- Next: v0.3 planning in [v0.3-handoff.md](v0.3-handoff.md)
